The [TFCABxxCAN01](https://docs.thunderfly.cz/avionics/TFCAB01/) cable is the ideal solution for data transmission on the CAN bus in drones with avionics that conform to the [Pixhawk standard](https://github.com/pixhawk/Pixhawk-Standards/blob/master/DS-009%20Pixhawk%20Connector%20Standard.pdf). The cable is manufactured to high performance and reliable connection and a twisted design that reduces internal cross-talk and minimizes coupling capacitance, ensuring a reliable and efficient transmission.

The cable utilizes the original JST-GH plastic connectors, ensuring a seamless connection between your drone's components. The used color scheme that corresponds to the [ThunderFly](https://www.thunderfly.cz/) color standard described in the [documentation](https://docs.thunderfly.cz/avionics/TFCAB01/), you can easily identify the type of bus to expect in the cable, reducing the possibility of incorrect connection.
...
### Parameters
 ...
 - Number of pins: 4
 - Designed for: [UAVCAN](https://en.wikipedia.org/wiki/Cyphal)
